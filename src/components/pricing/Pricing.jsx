...
import "./Pricing.css";
import Basic from "../../assets/Price/Basic.svg";
import Premium from "../../assets/Price/Premium.svg";
import Utlimate from "../../assets/Price/Ultimate.svg";
    ...
    <section className="pricing container section">
      ...
      <div className="pricing__container grid">
        <div className="pricing__item">
          <img src={Basic} alt="" className="pricing__img" />
        ...
        <div className="pricing__item best">
          ...
          <img src={Premium} alt="" className="pricing__img" />
        ...
        <div className="pricing__item">
          <img src={Utlimate} alt="" className="pricing__img" />
